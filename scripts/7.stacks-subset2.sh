...
POPMAP2=$src/pop-final.noblank.txt
...
#cstacks -n 3 -P $src/stacks2/ -M $POPMAP1 -p 100

#
# Run sstacks. Match all samples supplied in the population map against the catalog.
#
echo "Re-Running sstacks on entire set of samples, this time including EDDA02-1A"
date

sstacks -P $src/stacks2/ -M $POPMAP2 -p 100
...
tsv2bam -P $src/stacks2/ -M $POPMAP2 --pe-reads-dir $DATA -t 100
...
gstacks -P $src/stacks2/ -M $POPMAP2 -t 32 
...
populations -P $src/stacks2/ -M $POPMAP2 --vcf \
